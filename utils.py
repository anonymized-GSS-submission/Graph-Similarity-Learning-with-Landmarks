...
#send message to your wechat by push plus
def sendmessage(title = 'title',content = 'test',template='html'):
    YourToken = ""
    url = f'http://www.pushplus.plus/send?token={YourToken}&title={title}&content={content}&template={template}'
    requests.get(url)
...
if __name__ == "__main__":
    sendmessage(title='123',content='123')